...
const data = [
  { id: 1, name: "Return at sorting", amount: "0", percentage: "0%" },
  { id: 2, name: "Return in transit", amount: "0", percentage: "0%" },
  { id: 3, name: "At first mile hub", amount: "0", percentage: "0%" },
  { id: 4, name: "Assigned for return", amount: "0", percentage: "0%" },
  { id: 5, name: "Return to merchant", amount: "$0" },
];

const ReverseDeliveries = () => {
  return (
    <>
      <DeliveryHeader title={"Reverse Deliveries"} />
...
export default ReverseDeliveries;
