...
const data = [
  ...
  { id: 2, name: "Delivered", amount: "0", percentage: "0%", active: true },
  { id: 3, name: "Partial Delivery", amount: "0", percentage: "0%" },
  { id: 4, name: "Exchange", amount: "0", percentage: "0%" },
...
const DeliveredDeliveries = () => {
  return (
    <>
      <DeliveryHeader title={"Delivered Deliveries"} />
          ...
          {data.map((item, index) => (
            <div
              ...
              className={`flex flex-col gap-2 ${
                item.active ? "bg-primaryLight" : "bg-light"
              } rounded p-5 w-full md:w-[150px] lg:w-[300px] h-[120px] justify-center`}
            >
